    ...
    if (success) {
        return (
            ...
            >
                ...
                <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Account Created!</h1>
                <p className="text-sm sm:text-base text-muted-foreground max-w-md">
                    Thank you for registering. You can now sign in to your account using your email and password.
                </p>
                    ...
                    <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2">
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormControl>
                                        <Input className="text-sm sm:text-base" placeholder="First name" {...field} />
                                    </FormControl>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormControl>
                                        <Input className="text-sm sm:text-base" placeholder="Last name" {...field} />
                                    </FormControl>
                                    <FormMessage className="text-xs sm:text-sm" />
                                </FormItem>
                            )}
                                ...
                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                    ...
                                    <SelectContent>
                                        {referralSources.map((source) => (
                                            <SelectItem key={source.value} value={source.value} className="text-sm sm:text-base">
                                                {source.label}
                                            </SelectItem>
                                        ))}
                                    </SelectContent>
